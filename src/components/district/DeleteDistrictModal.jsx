...
export default function DeleteDistrictModal({ open, handleClose, id }) {
  const { deleteData } = useDeleteData("/districts/" + id);
  ...
  return (
    ...
    >
      <div className="bg-white box-border p-4 rounded-sm transition-all">
        {pending ? (
          <h1>Suppression</h1>
        ) : (
          <>
